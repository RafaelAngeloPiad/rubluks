...
tool.Equipped:Connect(function()
	...
	tool.Activated:Connect(function()
		...
		if clickCount == 1 then
			animTrack1:Play()
			animTrack1.Stopped:Once(function() isAttacking = false end)
