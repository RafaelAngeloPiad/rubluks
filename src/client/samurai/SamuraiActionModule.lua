...
function SamuraiActions._setCooldown(skillName, isOnCooldown, remainingTime)
...
function SamuraiActions.isSkillOnCooldown(skillName)
	...
	local remaining = SamuraiActions.getCooldownRemaining(skillName)
	return remaining > 0
end
...
function SamuraiActions.getCooldownRemaining(skillName)
