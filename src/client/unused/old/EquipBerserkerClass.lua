...
-- local ShowButtonPrompt = ReplicatedStorage:WaitForChild("ShowButtonPromptBerserker")
-- local EquipBerserkerClass = ReplicatedStorage:WaitForChild("EquipBerserkerClass")
-- local Players = game:GetService("Players")
-- local LocalPlayer = Players.LocalPlayer

-- -- Utility function to check if Berserker tool is present in Backpack or Character
-- local function hasBerserkerTool()
-- 	local backpack = LocalPlayer:FindFirstChild("Backpack")
-- 	if backpack then
-- 		for _, tool in backpack:GetChildren() do
-- 			if tool:IsA("Tool") and string.find(tool.Name, "Equip Berserker Class") then
-- 				return true
-- 			end
-- 		end
-- 	end
...
-- local BerserkerToolEquipped = false

-- -- Function to update the flag when tool is added/removed
-- local function updateBerserkerToolFlag()
-- 	BerserkerToolEquipped = hasBerserkerTool()
-- end
...
-- 	local backpack = LocalPlayer:FindFirstChild("Backpack")
-- 	if backpack then
-- 		backpack.ChildAdded:Connect(updateBerserkerToolFlag)
-- 		backpack.ChildRemoved:Connect(updateBerserkerToolFlag)
-- 	end
-- 	LocalPlayer.CharacterAdded:Connect(function(character)
-- 		character.ChildAdded:Connect(updateBerserkerToolFlag)
-- 		character.ChildRemoved:Connect(updateBerserkerToolFlag)
-- 		-- Initial check when character spawns
-- 		updateBerserkerToolFlag()
-- 	end)
-- 	-- Initial check for current character
-- 	if LocalPlayer.Character then
-- 		LocalPlayer.Character.ChildAdded:Connect(updateBerserkerToolFlag)
-- 		LocalPlayer.Character.ChildRemoved:Connect(updateBerserkerToolFlag)
-- 	end
-- end
...
-- 	updateBerserkerToolFlag()
-- 	if BerserkerToolEquipped then
-- 		-- Don't show prompt if Berserker tool is equipped
-- 		return
-- 	end
...
-- 	textLabel.Text = "Do you want to become an Berserker?"
...
-- 		if not hasBerserkerTool() then
-- 			BerserkerToolEquipped = false
-- 		end
-- 	end
-- 	local backpack = LocalPlayer:FindFirstChild("Backpack")
-- 	if backpack then
