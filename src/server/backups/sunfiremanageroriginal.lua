...
Players.PlayerAdded:Connect(function(plr)
	...
	plr.CharacterAdded:Connect(function(character)
		...
		if data2 and not plr:GetAttribute("SunfireLoaded") then
			...
			local mbk = sf:WaitForChild("MiniBossKill")
			mbk.MiniBossKillOne.Value = data2.MiniBossKillOne or false
			mbk.MiniBossKillTwo.Value = data2.MiniBossKillTwo or false
			mbk.MiniBossKillThree.Value = data2.MiniBossKillThree or false
			mbk.MiniBossKillFourth.Value = data2.MiniBossKillFourth or false
			mbk.MiniBossKillFifth.Value = data2.MiniBossKillFifth or false
	...
	while task.wait(60) do
		...
		local minibosskillFolder = sunfireprogress:WaitForChild("MiniBossKill")
		...
		if sunfireprogress and MainDataStore then
			...
			local dataToSave = {
				...
				CurrentDamagedKey = sunfireprogress.CurrentDamagedKey.Value,
				CurrentRefinedKey = sunfireprogress.CurrentRefinedKey.Value,
				MiniBossKillOne = minibosskillFolder.MiniBossKillOne.Value,
				MiniBossKillTwo = minibosskillFolder.MiniBossKillTwo.Value,
				MiniBossKillThree = minibosskillFolder.MiniBossKillThree.Value,
				MiniBossKillFourth = minibosskillFolder.MiniBossKillFourth.Value,
				MiniBossKillFifth = minibosskillFolder.MiniBossKillFifth.Value
