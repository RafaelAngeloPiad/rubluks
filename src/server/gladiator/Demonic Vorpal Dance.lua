...
local function playSkillCamera()
	...
	local sequence = {
		{cf = root.CFrame * CFrame.new(0, 1, -10) * CFrame.Angles(0, math.rad(180), 0), tweenTime = 0, holdTime = 0.5},
		{cf = root.CFrame * CFrame.new(8, -1.5, -1.5) * CFrame.Angles(0, math.rad(90), 0), tweenTime = 1, holdTime = 0.5},
		{cf = root.CFrame * CFrame.new(-8, 150, 0) * CFrame.Angles(math.rad(-90), math.rad(-20), 0), tweenTime = 0, holdTime = 4},
		{cf = root.CFrame * CFrame.new(0, 100, 100) * CFrame.Angles(math.rad(-40), math.rad(0), 0), tweenTime = 0, holdTime = 4}
