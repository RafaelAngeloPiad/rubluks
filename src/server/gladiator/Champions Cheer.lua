...
local function playSkillCamera()
	...
	local sequence = {
		{cf = root.CFrame * CFrame.new(-5, 1.5, -20) * CFrame.Angles(0, math.rad(-150), 0), tweenTime = 0, holdTime = 0.5},
		{cf = root.CFrame * CFrame.new(-2, 2, -3.5) * CFrame.Angles(0, math.rad(-150), 0), tweenTime = 0.3, holdTime = 1},
...
tool.Equipped:Connect(function()
	...
	animTrack:GetMarkerReachedSignal("AuraStart"):Connect(function()
		...
		local vfx = ReplicatedStorage.ChampionCheer:WaitForChild("Aura"):Clone()
